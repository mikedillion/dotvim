...
git submodule add https://github.com/AndrewRadev/splitjoin.vim bundle/splitjoin.vim
git submodule add https://github.com/tpope/vim-dispatch bundle/vim-dispatch
```
